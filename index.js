...
console.log ("My letter grade is" + calculatedGrade (average1), ";because my numerical ave. is", calculateAverage (average1));
...
function calculatedGrade (marks) {
  ...
  function calculateAverage (arrays) {
    let sum = 0;
    for (let arrays of average1) sum += array; //Example of reading an array and one line to add up the sum of all the grades
