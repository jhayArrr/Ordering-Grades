...
console.log ("My letter grade is", calculatedGrade(average2), "because my numerical average is", calculatedAverage(average1));

function calculatedGrade(average2) = calculatedAverage(average1) {
